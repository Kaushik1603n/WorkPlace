    ...
    <div className="min-h-screen bg-green-50 flex items-center justify-center">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-12">
          {/* Title */}
          <h2 className="text-3xl font-bold text-center mb-16">Join as a client or freelancer</h2>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 mb-12">
            ...
            <div 
              className={`border-2 rounded-xl p-6 cursor-pointer flex items-start gap-4 relative
                ${selectedType === 'client' ? 'border-green-500' : 'border-gray-300'}`}
            ...
            >
              ...
              <div className="absolute top-6 right-6 h-6 w-6 rounded-full border-2 border-gray-300 flex items-center justify-center">
                {selectedType === 'client' && <div className="h-3 w-3 rounded-full bg-green-500"></div>}
              </div>
            ...
            <div 
              className={`border-2 rounded-xl p-6 cursor-pointer flex items-start gap-4 relative
                ${selectedType === 'freelancer' ? 'border-green-500' : 'border-gray-300'}`}
              onClick={() => handleTypeSelection('freelancer')}
            >
              {/* Radio Button */}
              <div className="absolute top-6 right-6 h-6 w-6 rounded-full border-2 border-gray-300 flex items-center justify-center">
                {selectedType === 'freelancer' && <div className="h-3 w-3 rounded-full bg-green-500"></div>}
              </div>
          ...
          <div className="text-center">
            <p className="text-lg">
              ...
              <a href="/login" className="text-green-500 hover:text-green-600 ml-2 font-medium">
                Login
              </a>
            </p>
          </div>
