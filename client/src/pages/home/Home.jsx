...
import { Users, Monitor, Code, FileText, CircleDollarSign } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex flex-col">
     ...
     <NavigationBar/>
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              The Ultimate Destination for <span className="text-green-500">Freelance Talent</span> and <span className="text-green-500">Quality Services!</span>
            </h2>
            <p className="text-gray-600 mb-8">
              Whether you're a business owner or a freelancer, WorkPlace is your one-stop-shop for finding or offering freelance services. Join our community today and start getting things done!
            </p>
            <div className="flex flex-wrap gap-4">
              <button className="bg-green-500 text-white px-6 py-3 rounded-md hover:bg-green-600 transition">Hire a freelancer</button>
              <button className="border border-green-500 text-green-500 px-6 py-3 rounded-md hover:bg-green-50 transition">Find Work</button>
            </div>
          </div>
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <CategoryCard icon={<Monitor size={32} className="mx-auto text-gray-700" />} title="Web Design" />
            <CategoryCard 
              icon={<Code size={32} className="mx-auto text-white" />} 
              title="Web Development" 
              highlighted={true}
            />
            <CategoryCard icon={<Users size={32} className="mx-auto text-gray-700" />} title="Software Engineer" />
            <CategoryCard icon={<FileText size={32} className="mx-auto text-gray-700" />} title="Graphic Designer" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-green-50 py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <div className="mb-8">
              <h4 className="text-lg font-semibold mb-2">The best for every budget</h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-2">Quality work done quickly</h4>
              <p className="text-gray-600">
      ...
      <section className="py-16 px-4 md:px-8 lg:px-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Our Freelancer</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
...
function CategoryCard({ icon, title, highlighted = false }) {
  return (
    <div className={`border rounded-lg p-8 flex flex-col items-center ${
      highlighted ? 'bg-green-400 text-white' : 'bg-white hover:border-green-300'
    }`}>
  ...
  return (
    <div className="bg-green-50 border border-green-100 rounded-lg p-6 flex flex-col items-center">
      ...
      <div className="flex w-full justify-between mt-auto">
        <button className="bg-green-500 text-white px-3 py-1 rounded text-sm">Meeting</button>
